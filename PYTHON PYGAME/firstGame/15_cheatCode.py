...
def welcome() :
    ...
    while (not exit_game) :
        ...
        text_score("Welcome To the Snake Xperia",black,200,250)
        text_score("Press 'Enter' Key To Play!!!",black,230,300)
...
def gameLoop() :
    ...
    while (not exit_game) :
        ...
        if (game_over) :
            ...
            text_score("Your Score is : "+str(score_final),black,280,200)
